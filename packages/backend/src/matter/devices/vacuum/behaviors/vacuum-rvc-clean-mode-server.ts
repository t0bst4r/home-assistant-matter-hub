...
import { RvcCleanModeServer, RvcSupportedCleanMode } from "../../../behaviors/rvc-clean-mode-server.js";
  ...
  getSupportedModes: () => [
    {
      ...
      modeTags: [{ value: RvcCleanMode.ModeTag.Quiet }, { value: RvcCleanMode.ModeTag.Vacuum }],
    },
    {
      label: "Normal",
      mode: RvcSupportedCleanMode.Normal,
      modeTags: [{ value: RvcCleanMode.ModeTag.Auto }, { value: RvcCleanMode.ModeTag.Vacuum }],
    },
    {
        label: "Turbo",
        mode: RvcSupportedCleanMode.Turbo,
        modeTags: [{ value: RvcCleanMode.ModeTag.DeepClean }, { value: RvcCleanMode.ModeTag.Vacuum }],
    },
    {
      label: "Max",
      mode: RvcSupportedCleanMode.Max,
      modeTags: [{ value: RvcCleanMode.ModeTag.Max }, { value: RvcCleanMode.ModeTag.Vacuum }],
    },
  ],
  changeFanSpeed: (vacuumFanSpeed) => {
   return { action: "vacuum.set_fan_speed", data: { fan_speed: vacuumFanSpeed } };
  }
});
